...
* [LLM-Sim-Alpha](https://github.com/Trainerx7979/LLM-Sim-Alpha) - Research-oriented emergent-behavior simulation where one NPC is secretly evil. Full JSONL logging of every agent brain state, visual log replay viewer, and configurable storyteller alignments. Built for studying emergent social dynamics. Prompts & responses logged per turn and reviewable in the interactive log player or by plain-text search.
