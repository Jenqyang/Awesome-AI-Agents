...
- [Hashgraph Online (HOL)](https://hol.org) - Universal agentic registry for AI agents with Universal Agent IDs (UAIDs) for cross-chain identity. Bridges to ERC-8004, A2A, Virtuals, x402. 187K+ verified agents.
