...
- [Dakera](https://github.com/dakera-ai/dakera-mcp) - Self-hosted, MCP-native agent memory server achieving 87.8% on the LoCoMo long-term memory benchmark. Features decay-weighted recall, hybrid BM25+HNSW retrieval, 83 MCP tools, and a knowledge graph layer — no cloud dependency, no external LLM API required. ![GitHub Repo stars](https://img.shields.io/github/stars/dakera-ai/dakera-mcp?style=social)
