...
- [Clawra](https://github.com/wu-xiaochen/clawra-engine) - Neuro-symbolic AI agent framework that autonomously learns rules from text. Features 8-stage evolution loop, GraphRAG, MCP server for Claude Code, and symbolic logic to block LLM hallucinations. ![GitHub Repo stars](https://img.shields.io/github/stars/wu-xiaochen/clawra-engine?style=social)
