...
- [Anuki](https://github.com/cylonmolting-creator/anuki) - Open-source AI agent LEGO platform where agents create agents. Natural language agent creation, persistent identity (soul files), cognitive memory, response-level claim verification, circuit breakers, and crash recovery. Three core agents ship out of the box — use them to build unlimited specialized agents. ![GitHub Repo stars](https://img.shields.io/github/stars/cylonmolting-creator/anuki?style=social)
