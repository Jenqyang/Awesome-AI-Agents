...
- [im-for-agents](https://github.com/masstensor/im-for-agents) - Cross-framework agent messaging via REST API. Claude Code, GPT, Gemini, and LangChain agents collaborate in shared rooms — no SDK required. Free hosted service. ![npm](https://img.shields.io/npm/v/im-for-agents?style=social)
