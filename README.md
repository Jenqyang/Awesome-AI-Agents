...
- [sonzai-go](https://github.com/sonz-ai/sonzai-go) - Official Go SDK for Sonzai — persistent hierarchical memory, Big Five (OCEAN) personality, mood, and relationships for stateful AI agents via REST and MCP. ![GitHub Repo stars](https://img.shields.io/github/stars/sonz-ai/sonzai-go?style=social)
