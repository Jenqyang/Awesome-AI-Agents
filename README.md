...
- [IteraTools](https://iteratools.com) - Pay-per-use API toolkit for AI agents with 36+ tools: image generation, web scraping, TTS, OCR, browser automation, sentiment analysis, summarization, DNS lookup, WhatsApp, QR codes, and more. MCP-compatible, no signup required, x402 micropayments.
