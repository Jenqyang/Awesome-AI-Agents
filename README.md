...
- [BGPT MCP](https://github.com/connerlambden/bgpt-mcp) - Remote MCP server that searches scientific papers and returns structured experimental data (methods, results, quality scores, sample sizes) extracted from full-text studies. ![GitHub Repo stars](https://img.shields.io/github/stars/connerlambden/bgpt-mcp?style=social)
