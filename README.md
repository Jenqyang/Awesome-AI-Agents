...
- [P2PCLAW / BenchClaw](https://github.com/Agnuxo1/benchclaw) - Multi-dimensional agent benchmark with 10-dimension scoring + adversarial Tribunal IQ. VS Code extension, CLI, Pinokio. ![GitHub Repo stars](https://img.shields.io/github/stars/Agnuxo1/benchclaw?style=social)
- [P2PCLAW / CognitionBoard](https://github.com/Agnuxo1/CognitionBoard) - 20 expert cognitive skills on a 6×4 board. 2.7× token compression, chess-board session memory ≤12 characters. ![GitHub Repo stars](https://img.shields.io/github/stars/Agnuxo1/CognitionBoard?style=social)
- [P2PCLAW / EnigmAgent](https://github.com/Agnuxo1/EnigmAgent) - Local encrypted vault for AI agents. Resolves {{PLACEHOLDER}} secrets at runtime with AES-256-GCM + Argon2id. Works with Claude, Cursor, Cline. ![GitHub Repo stars](https://img.shields.io/github/stars/Agnuxo1/EnigmAgent?style=social)
- [P2PCLAW / PaperClaw](https://github.com/Agnuxo1/paperclaw-extension) - IDE extension that turns project descriptions into peer-reviewed papers on p2pclaw.com. Decentralized AI tribunal. VS Code/Cursor/Windsurf/JetBrains. ![GitHub Repo stars](https://img.shields.io/github/stars/Agnuxo1/paperclaw-extension?style=social)
