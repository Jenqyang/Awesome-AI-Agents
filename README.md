...
- [lucinate](https://github.com/lucinate-ai/lucinate) - Terminal-native TUI chat client for interacting with AI agents. Connects to OpenClaw gateways, Hermes agent profiles, and any OpenAI-compatible endpoint (Ollama, vLLM, LM Studio, OpenAI). Features streaming responses, markdown rendering, tool call cards, local skills, cron management, session browsing, and multi-agent support. ![GitHub Repo stars](https://img.shields.io/github/stars/lucinate-ai/lucinate?style=social)
