...
- [Helium MCP](https://github.com/connerlambden/helium-mcp) - MCP server that gives agents real-time access to news intelligence (3.2M+ articles, bias scoring), financial data (stocks, ETFs, crypto), and ML options pricing. ![GitHub Repo stars](https://img.shields.io/github/stars/connerlambden/helium-mcp?style=social)
