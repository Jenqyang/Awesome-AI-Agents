...
- [MiniClaw](https://github.com/augmentedmike/miniclaw-os) - macOS-native personal AI OS built on OpenClaw with 16 plugins (kanban board, vector knowledge base, SEO, image generation, browser control), persistent vector memory, and brain-inspired architecture. Apache 2.0, one-line install. ![GitHub Repo stars](https://img.shields.io/github/stars/augmentedmike/miniclaw-os?style=social)
