...
- [TokenFence](https://github.com/u4ma-kev/tokenfence-python) - Cost circuit breaker + runtime guardrails SDK for AI agents. Per-workflow budgets, automatic model downgrade, kill switch, and least-privilege policy engine with audit trail. Python ([PyPI](https://pypi.org/project/tokenfence/)) + [Node.js](https://github.com/u4ma-kev/tokenfence-node) ([npm](https://www.npmjs.com/package/tokenfence)). Zero dependencies, MIT licensed. ![GitHub Repo stars](https://img.shields.io/github/stars/u4ma-kev/tokenfence-python?style=social)
