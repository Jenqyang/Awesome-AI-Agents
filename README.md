...
- [ShopSavvy MCP](https://github.com/shopsavvy/shopsavvy-mcp-server) - Open-source MCP server that gives agents product lookups, real-time pricing, price history, deal discovery, and expert buying guides across thousands of retailers. One-command install, no signup for the free tier. ![GitHub Repo stars](https://img.shields.io/github/stars/shopsavvy/shopsavvy-mcp-server?style=social)
