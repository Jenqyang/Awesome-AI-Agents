...
- [Skillfold](https://github.com/byronxlg/skillfold) - Configuration language and compiler for multi-agent AI pipelines. Compiles a single YAML config into agent skills for 11 platforms including Claude Code, Cursor, Copilot, and Gemini. ![GitHub Repo stars](https://img.shields.io/github/stars/byronxlg/skillfold?style=social)
