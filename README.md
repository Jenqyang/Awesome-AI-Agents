...
- [AgentSkeptic](https://github.com/jwekavanagh/agentskeptic) - Validates AI/agent workflows by asserting post-execution database state matches expected outcomes using read-only SQL.
