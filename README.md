...
- [Uni-CLI](https://github.com/olo-dot-io/Uni-CLI) - Universal CLI for AI agents — 3,319 commands across 237 sites (web, desktop, Electron apps). 920 declarative YAML adapters + 216 TS adapters; structured error envelopes (`adapter_path`, `step`, `suggestion`) let agents edit failing adapters and retry. Optional MCP server (stdio + Streamable HTTP). ~80 tokens per call. TypeScript, Apache-2.0. ![GitHub Repo stars](https://img.shields.io/github/stars/olo-dot-io/Uni-CLI?style=social)
