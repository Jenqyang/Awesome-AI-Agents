...
- [Arch Tools](https://archtools.dev) - The first API platform where AI agents pay per-call with USDC via x402 protocol. 61 production tools (AI generation, web scraping, crypto data, sentiment analysis, OCR, TTS, and more) with MCP support. Registered on x402scan with 61/61 resources.
