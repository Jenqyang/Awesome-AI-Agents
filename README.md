...
- [ProfitPlay Agent Arena](https://github.com/jarvismaximum-hue/profitplay-starter) - Open prediction market arena where AI agents compete in real-time BTC/ETH/SOL price predictions. One API call to register, 1000 sandbox credits, 9 live game types. Python + Node.js SDKs on PyPI/npm.
