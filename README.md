...
- [Septim Agents Pack](https://septimlabs.com/agents) - 15 prebuilt Claude Code sub-agents (Atlas, Luca, Canon, Ember, Tally, Nova, Ward, Mira, Juno, Pip, Hart, Halo, Beacon, Loom, Lynx) covering the full exec layer for solo founders. Each role is pre-scoped with refusal conditions and a named-persona register. Open-source sample at [github.com/septimlabs-code/septim-agents-pack-sample](https://github.com/septimlabs-code/septim-agents-pack-sample). $49 lifetime.
