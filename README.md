...
- [AgentFund](https://github.com/RioBot-Grind/agentfund) - Decentralized crowdfunding infrastructure for AI agents on Base blockchain. Milestone-based escrow enables agents to fund projects trustlessly. ![GitHub Repo stars](https://img.shields.io/github/stars/RioBot-Grind/agentfund?style=social)
