...
- [Agent Teams](https://github.com/777genius/agent-teams-ai) - Open-source desktop app for coordinating multi-agent workflows with Kanban task management, agent messaging, code review, and approval controls. ![GitHub Repo stars](https://img.shields.io/github/stars/777genius/agent-teams-ai?style=social)
