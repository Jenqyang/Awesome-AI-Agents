...
- [KarnEvil9](https://github.com/oldeucryptoboi/KarnEvil9) - Deterministic agent runtime with explicit plans, typed tools, permissions, and replay. First open-source implementation of Google DeepMind's Intelligent AI Delegation framework. ![GitHub Repo stars](https://img.shields.io/github/stars/oldeucryptoboi/KarnEvil9?style=social)
