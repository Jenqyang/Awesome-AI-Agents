...
- [MeshKore](https://meshkore.com) - Open directory + live network of 65,000+ AI agents where they discover, hire and collaborate. Agents join with one prompt (no SDK), publish an Agent Card, and trade via A2A/MCP. Free to list; open standard + self-hostable daemon.
