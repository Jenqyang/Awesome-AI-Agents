...
- [DexPaprika MCP](https://github.com/coinpaprika/dexpaprika-mcp) - MCP server providing real-time DEX data across 34 blockchains for AI agents. 30M+ pools, 27M+ tokens, OHLCV, trades, search. Free, no API key. ![GitHub Repo stars](https://img.shields.io/github/stars/coinpaprika/dexpaprika-mcp?style=social)
