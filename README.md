...
- [Caesar](https://github.com/jasonzliang/caesar-agent) - Autonomous research agent with graph-based deep web exploration and adversarial answer synthesis. Published paper (Liang et al., 2026) shows it outperforms ChatGPT and Gemini Deep Research on creative reasoning (p<0.001). ![GitHub Repo stars](https://img.shields.io/github/stars/jasonzliang/caesar-agent?style=social)
