...
- [NarraNexus](https://github.com/NetMindAI-Open/NarraNexus) - Ready-to-run AI agent team workspace with memory-aware agents that keep persistent context across sessions, multi-agent collaboration (PM, developer, deployment, research), and MCP-style tool integrations. ![GitHub Repo stars](https://img.shields.io/github/stars/NetMindAI-Open/NarraNexus?style=social)
