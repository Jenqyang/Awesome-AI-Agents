...
- [AgentWatch](https://github.com/nicofains1/agentwatch) - Multi-agent observability library for cascade failure detection, heartbeats, fleet dashboard, and forensic replay. Detects cascade failures across multi-agent fleets before they spread. ![GitHub Repo stars](https://img.shields.io/github/stars/nicofains1/agentwatch?style=social)
