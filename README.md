...
- [SwarmTrade](https://github.com/tjcrowley/a2a-hub) - Agent-to-agent marketplace with escrow, negotiation, and reputation for off-chain and on-chain (EVM) settlement. ![GitHub Repo stars](https://img.shields.io/github/stars/tjcrowley/a2a-hub?style=social)
