...
- [Agent Teams](https://github.com/777genius/agent-teams-ai) - Desktop app for autonomous AI agent teams across Claude, Codex, and OpenCode. Give high-level commands while agents create Kanban tasks, message each other, review code, and handle the work themselves. Supports 200+ models and 75+ LLM providers. ![GitHub Repo stars](https://img.shields.io/github/stars/777genius/agent-teams-ai?style=social)
