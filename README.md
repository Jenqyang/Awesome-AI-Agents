...
- [ATXP](https://github.com/atxp-dev/atxp) - Agent identity and payment infrastructure. One command (`npx atxp agent register`) gives an AI agent a USDC wallet, `@atxp.email` inbox, phone number, and 100+ paid tools (web search, image generation, LLM gateway, SMS, voice). No human login, no KYC. $5 free credit. ![GitHub Repo stars](https://img.shields.io/github/stars/atxp-dev/atxp?style=social)
