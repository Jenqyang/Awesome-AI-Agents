...
- [Luminy](https://github.com/feralbureau/luminy) - Local-first agentic AI coding assistant with MCP support, built with Tauri. Supports Ollama, OpenAI, Anthropic, Gemini, GitHub Copilot, and more. ![GitHub Repo stars](https://img.shields.io/github/stars/feralbureau/luminy?style=social)
