...
### Tools
- [Dakera](https://github.com/Dakera-AI/dakera) - Self-hosted agent memory server with hybrid BM25 + HNSW vector retrieval, decay-weighted recall, multi-agent namespacing, and MCP integration. SDKs for Python, TypeScript, Go, and Rust. ![GitHub Repo stars](https://img.shields.io/github/stars/Dakera-AI/dakera?style=social)
