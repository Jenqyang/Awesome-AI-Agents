...
- - [Threadline](https://threadline.to) - Persistent context layer for AI agents with an open schema standard. Two lines of code: inject() before your LLM call, update() after. User-owned context with OAuth-style scoped grants, full audit trail, and ~38ms p50 retrieval. Open schema spec: 7 typed scopes, portable across models and frameworks. ![GitHub Repo stars](https://img.shields.io/github/stars/vidursharma202-del/context-schema?style=social)
