...
- [BGPT MCP](https://github.com/connerlambden/bgpt-mcp) - MCP server for searching scientific papers with full-text experimental data extraction. 50 free searches, no API key. ![GitHub Repo stars](https://img.shields.io/github/stars/connerlambden/bgpt-mcp?style=social)
