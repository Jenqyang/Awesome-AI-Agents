...
- [Ivy Tendril](https://github.com/Ivy-Interactive/Ivy-Tendril) - Open-source AI coding orchestrator managing Claude Code, Codex, Antigravity, Copilot, and OpenCode through plan-based lifecycle with verification gates and self-improving memory. [Website](https://tendril.ivy.app) ![GitHub Repo stars](https://img.shields.io/github/stars/Ivy-Interactive/Ivy-Tendril?style=social)
