...
- [agent-qa](https://github.com/vostride/agent-qa) - Self-improving agentic QA harness with memory for natural-language web and mobile test execution. ![GitHub Repo stars](https://img.shields.io/github/stars/vostride/agent-qa?style=social)
