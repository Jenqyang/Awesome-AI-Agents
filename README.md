...
- [recall-mcp](https://github.com/mturac/recall-mcp) - Shared brain for AI agents — SQLite-backed persistent memory over the Model Context Protocol with hybrid FTS5 + vector search, human-cognition-inspired memory decay (STRONG/MEDIUM/WEAK), and namespace isolation. ![GitHub Repo stars](https://img.shields.io/github/stars/mturac/recall-mcp?style=social)
- [skill-hunter](https://github.com/mturac/skill-hunter) - Pre-execution discovery layer. UserPromptSubmit hook that forces an agent to check for an existing skill / MCP / CLI / library before building anything from scratch. Adapters for Claude Code, Codex, OpenClaw, Hermes, and Cursor. ![GitHub Repo stars](https://img.shields.io/github/stars/mturac/skill-hunter?style=social)
- [promptguard](https://github.com/mturac/promptguard) - Audits LLM prompts and agent instructions as behavioral contracts. Pre-write guard for agents that ship code — flags vague intent, missing responsibility, false certainty, conflicting rules. ![GitHub Repo stars](https://img.shields.io/github/stars/mturac/promptguard?style=social)
- [argus-audit](https://github.com/mturac/pluginpool-argus-audit) - Scope-gated white-hat security audit + pentest orchestrator for agent-generated code — cryptographic ownership-proof vault, self-updating CVE intel (NVD/KEV/EPSS), five scanner surfaces (AST taint / secrets / supply-chain / TLS / HTTP probes). Stdlib-only Python, 174 hermetic tests. ![GitHub Repo stars](https://img.shields.io/github/stars/mturac/pluginpool-argus-audit?style=social)
- [leyla-scheduler](https://github.com/mturac/leyla-scheduler) - Durable, session-aware task scheduler in Rust. Cron-style triggers, leases, replace-running semantics; jobs and runs survive disconnects. ![GitHub Repo stars](https://img.shields.io/github/stars/mturac/leyla-scheduler?style=social)
- [claude-roundtable](https://github.com/mturac/claude-roundtable) - Multi-agent governance for Claude Code. Council deliberates, votes (weighted), dispatches work to specialised council agents, and enforces quality gates. ![GitHub Repo stars](https://img.shields.io/github/stars/mturac/claude-roundtable?style=social)
