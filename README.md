...
- [GreatCTO](https://github.com/avelikiy/great_cto) - Multi-agent SDLC orchestrator above Claude Code, Cursor, Codex, Aider, and Continue. 34 specialist agents (architect, pm, parallel senior-dev pool, qa, security, archetype-specific reviewers, devops) coordinated by a deterministic state machine. 25 archetype overlays (fintech, healthcare, agent-product, voice-AI) auto-wire compliance gates (PCI, HIPAA, EU AI Act, TCPA). Two human gates per feature; everything else runs unattended. Published methodology page for the cross-project memory layer (47 paired P0 incidents). ![GitHub Repo stars](https://img.shields.io/github/stars/avelikiy/great_cto?style=social)
