...
- [Ariadne Loop](https://github.com/zhangzeyu99-web/ariadne-loop) - Local Python CLI for turning rough agent tasks into verifiable loop specs, execution packets, and JSONL supervision decisions. ![GitHub Repo stars](https://img.shields.io/github/stars/zhangzeyu99-web/ariadne-loop?style=social)
