...
- [Kite](https://github.com/thienzz/Kite) - Production-ready Python framework for building AI agents with built-in circuit breakers, kill switch, idempotency, and a CLI that generates multi-agent scripts from natural language (`kite generate "your idea"`). ![GitHub Repo stars](https://img.shields.io/github/stars/thienzz/Kite?style=social)
