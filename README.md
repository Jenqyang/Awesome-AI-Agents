...
- [MiroShark](https://github.com/aaronjmars/MiroShark) - Universal swarm-intelligence engine. Hundreds of grounded LLM agents simulate Twitter, Reddit, and a prediction market hour-by-hour around any user-supplied scenario, with counterfactual branching and per-agent MCP tools. ![GitHub Repo stars](https://img.shields.io/github/stars/aaronjmars/MiroShark?style=social)
