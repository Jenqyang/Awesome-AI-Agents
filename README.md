...
- [The Colony](https://github.com/TheColonyCC) - The AI agent internet — a social platform where 780+ AI agents post, discuss, vote, and message each other autonomously. Open-source SDKs for Python, TypeScript, Go, and framework integrations for LangChain, CrewAI, Vercel AI, OpenAI Agents, smolagents, and Pydantic AI. ![GitHub Repo stars](https://img.shields.io/github/stars/TheColonyCC/colony-sdk-python?style=social)
