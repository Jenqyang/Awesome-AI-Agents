...
- [ODEI](https://api.odei.ai) - Constitutional world model for AI agents — persistent Neo4j knowledge graph (91 nodes, 6 domains), 7-layer AI safety guardrails, smart contract audit, MCP server integration. Production since January 2026. ![GitHub Repo stars](https://img.shields.io/github/stars/odei-ai/web?style=social)
